...
export const FAQSection = () => {
  ...
  const faqs = [
    ...
    {
      question: 'Можно ли интегрировать с Telegram, WhatsApp, VK?',
      answer: 'Да! На тарифе Бизнес доступен Telegram, на тарифе Премиум — все мессенджеры (Telegram, WhatsApp, VK, MAX). Один бот работает во всех каналах одновременно, используя одну базу знаний.'
    },
    {
