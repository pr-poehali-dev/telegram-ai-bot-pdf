          ...
          <CardContent className="prose prose-sm max-w-none space-y-6">
            <section>
              ...
              <p>
                ...
                ИП Нехорошев Антон Александрович (далее — Исполнитель) и любым лицом (далее — Пользователь), 
                использующим сервис AI-консультант для отелей, размещенный по адресу ai-ru.ru (далее — Сервис).
              </p>
              <p>
                Использование Сервиса означает безоговорочное согласие Пользователя с настоящим Соглашением 
                и указанными в нем условиями. Если Пользователь не согласен с условиями Соглашения, 
